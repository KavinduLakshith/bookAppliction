...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Book Finding System   </title>
...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  ...
  <header class="border-bottom lh-1 ">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <!-- Use navbar-dark for contrast -->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    @if(!in_array(Route::currentRouteName(), ['login', 'register']))
                        <li class="nav-item">
                            <a class="nav-link active text-white" href="{{ route('books.index') }}">Home</a>
                        </li>
                    @endif
                    @if(auth()->check() && auth()->user()->role === 'author')
                        <li class="nav-item">
                            <a class="nav-link active text-white" href="{{ route('books.create') }}">Add Book</a>
                        </li>
                    @endif
                </ul>
                    ...
                    @if (Route::is('books.index'))
                        <form action="{{ route('books.index') }}" method="GET" class="d-flex me-2">
                            <input type="text" name="search" class="form-control me-2"
                                placeholder="Search Book Details..." value="{{ request('search') }}">
...
{{-- <div class="container min-vh-100"
     style="background-image: url('{{ asset('OIP (2).png') }}');
...
<footer class="py-5 text-center text-body-secondary bg-body-tertiary">
  <p>Lorem Ipsum is simply dummy text of the printing <a href="">Lorem</a> by <a href="">Test</a>.</p>
  <p class="mb-0">
